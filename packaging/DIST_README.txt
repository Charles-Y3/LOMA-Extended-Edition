...
LOMA Core Edition is a privacy-first, offline AI workspace — chat,
document generation, and multimodal file understanding (documents,
presentations, spreadsheets, audio, images, video), all running locally on
...
Unzip this folder anywhere and double-click "LOMA Core Edition.exe" inside
it. It opens in your default web browser at http://127.0.0.1:8000 — that
browser tab is the app's interface; the .exe itself just runs the local
server behind it.
...
------------------------------------------------------------
LOMA Core Edition needs Ollama installed and running locally to serve the
language/vision models it uses. If it isn't detected, the app will guide
you through installing it and pulling a model the first time you run it.

============================================================
PRIVACY AND OFFLINE USE
============================================================

LOMA Core Edition runs entirely on your own machine:
...
Your chats, settings, and ingested documents (Document Intelligence / RAG)
are NOT stored in this folder — they live in a per-user AppData folder
instead, so they survive you replacing this folder with a newer version
later (no re-ingesting your documents after every update).
...
LOMA Core Edition is built on the following open-source projects, among
...
LOMA Core Edition is an AI-assisted system designed to support your own
