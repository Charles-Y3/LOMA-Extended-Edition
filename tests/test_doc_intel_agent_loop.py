...
from extensions.document_intelligence.corpus.workspace import WorkspaceSession
...
class AgentLoopTests(unittest.TestCase):
    ...
    @patch("extensions.document_intelligence.agent.loop.run_analyze", return_value="draft answer")
    @patch(
        "extensions.document_intelligence.agent.loop._review_sufficiency",
    ...
    @patch("extensions.document_intelligence.agent.loop.run_analyze", return_value="draft")
    @patch(
        "extensions.document_intelligence.agent.loop._review_sufficiency",
        side_effect=[
