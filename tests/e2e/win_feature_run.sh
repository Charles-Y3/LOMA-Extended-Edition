...
APPDATA="$(cygpath -w "$H")" LOMA_PORT=8765 LOMA_BROWSER_OPENED=1 LOMA_SELFTEST=1 LOMA_E2E_KEEP_ALIVE=1 \
  LOMA_E2E_PICK_FOLDER="${LOMA_E2E_PICK_FOLDER:-}" LOMA_E2E_WIZARD_STEP="${LOMA_E2E_WIZARD_STEP:-}" \
  LOMA_E2E_IMAGE_MODEL="${LOMA_E2E_IMAGE_MODEL:-}" LOMA_E2E_IMAGE_SIZE="${LOMA_E2E_IMAGE_SIZE:-}" \
