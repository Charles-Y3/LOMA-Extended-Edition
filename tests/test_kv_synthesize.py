...
from extensions.knowledge_vault.corpus.types import ChunkRecord, HitRecord, TaskKind
from extensions.knowledge_vault.retrieval.synthesize import _page_label, synthesize
...
class CitationRenumberingTests(unittest.TestCase):
    @patch("extensions.knowledge_vault.retrieval.synthesize.ludicity_chat")
