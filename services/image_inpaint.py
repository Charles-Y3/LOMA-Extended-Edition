...
def swap_subject_local(
    *,
    ...
    prompt = require_english_prompt(prepare_image_prompt(instruction or "edit the subject"))
...
def swap_background_local(
    *,
    ...
    prompt = require_english_prompt(prepare_image_prompt(instruction or "change the background"))
...
def inpaint_image_local(
    *,
    ...
    prompt = require_english_prompt(prepare_image_prompt(instruction or "edit the masked region"))
