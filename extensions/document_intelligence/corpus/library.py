...
from extensions.document_intelligence.corpus.types import (
    ChunkRecord,
    LibraryManifest,
...
from extensions.document_intelligence.settings import libraries_root
...
class LibraryCorpus:
    ...
    def delete_file(self, abs_path: str) -> bool:
        ...
        if self.manifest.semantic_ready or self.manifest.semantic_enabled:
            from extensions.document_intelligence.index.semantic import delete_chunk_ids
            ...
            try:
                ...
                for idx, (root, path) in enumerate(paths):
                    ...
                    if old and abs(old[0] - mtime) < 0.01 and old[1] == size:
                        ...
                        try:
                            all_pairs.extend(
                                pairs_from_file(path, display_path=disp)
                            )
    ...
    def build_semantic_index(
        ...
        *,
        ...
        def _run():
            ...
            error = ""
            try:
                from extensions.document_intelligence.index.semantic import build_semantic_index
...
def _existing_semantic_count(library_id: str) -> int:
    from extensions.document_intelligence.index.semantic import _existing_ids
