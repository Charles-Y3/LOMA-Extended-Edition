...
from extensions.document_intelligence.corpus.types import ReasoningMode, TaskKind
...
from extensions.document_intelligence.retrieval.framing import is_analysis_style_query
from extensions.document_intelligence.retrieval.synthesize import synthesize
...
def _compress_hits(query: str, hits: list) -> list:
    ...
    from extensions.document_intelligence.retrieval.context_builder import group_hits_by_file
