...
from extensions.document_intelligence.corpus.types import HitRecord, ReasoningMode, TaskKind
from extensions.document_intelligence.retrieval.context_builder import (
    _CHARS_PER_TOKEN,
    group_hits_by_file,
)
from extensions.document_intelligence.retrieval.search_format import format_no_hits_message
...
def _fit_hits_to_hardware(
    ...
    """
    from extensions.document_intelligence.retrieval.cpu_budget import (
...
def _format_citations(indexed_groups: list[tuple[int, tuple]]) -> str:
...
def synthesize(
    ...
    *,
    ...
    # rule only covers en/zh_tw/zh_cn/es/de) — a DI question can be asked in any
    ...
    # the source material's language.
