# -*- coding: utf-8 -*-
"""Text extraction and chunking for Knowledge Vault."""
...
from extensions.knowledge_vault.indexing_locks import file_appears_locked, note_locked_file
...
def _open_pdf(file_path: str, *, settings_pw: str, log_fn: LogFn | None):
    ...
    from extensions.knowledge_vault.passwords import (
        password_attempts,
        remember_password,
        remember_skip,
