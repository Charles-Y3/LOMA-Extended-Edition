...
from extensions.knowledge_vault.ui.fs_tree import build_filesystem_tree, build_index_tree
...
class WorkspaceSession:
    ...
    def excluded_file_count(self) -> int:
        ...
        from extensions.knowledge_vault.corpus.library import chunk_abs_path
        from extensions.knowledge_vault.corpus.types import fully_excluded_file_keys
